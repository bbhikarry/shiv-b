---
title: "First week"
subtitle: "&#x2694;&#xFE0F; Shiva +<br/>&#x1F60E; begins programming"  
author: 
  - "B Bhikarry"
  - "S Beharry"
date: '`r Sys.Date()`'
...
Whatever happens now will depend on focus.

<input type= "checkbox" unchecked> <strong>World Wide Web</strong>?</input>

<input type= "checkbox" unchecked> <strong>Desktop publishing</strong>?</input>

The tools however remain the same;

[Language](https://www.northeastern.edu/graduate/blog/most-popular-programming-languages/#:~:text=Web%2Dbased%20startups%20are%20more,R%20and%20MATLAB%20programming%20languages.) > [IDE]() > [Editor]()  
---
## Typography
